...
const ListPropertiesEmailForm = ({onClickNext} : IListPropertiesEmailFormProps) => {
...
if (isLoading){
 ...
 sx={{
          "& .MuiInputBase-input.Mui-disabled": {
            ...
            Disclaimer : The account you are signed in with will be used to associate the hotels.
            Please create and login with a different account if required.
            </Typography>
            <Button
